                    ...
                    <div class="card mb-3 w-100">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-3 m-auto">
                                <img src="{{ $opportunity->image }}" alt="Opportunity Image"
                                    class="img-fluid rounded-start rounded" height="245" width="245" />
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="col-sm-5">{{ $opportunity->name }}</div>
                                    </div>

                                    <div class="d-flex mb-3">
                                        <div class="col-md-2 fw-bold">العنوان</div>
                                        <div class="col-sm-5">{{ $opportunity->address }}</div>
                                    </div>

                                    <div class="d-flex mb-3">
                                        <div class="col-md-2 fw-bold">رقم التواصل</div>
                                        <div class="col-sm-5">{{ $opportunity->phone }}</div>
                                    </div>
