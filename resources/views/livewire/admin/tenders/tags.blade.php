<div class="container-fluid">
    <div class="p-4 mb-4">
        ...
        <div class="row mb-4" wire:ignore>
            ...
            <!-- Page Title  -->
            <h2 style="font-weight: bold;">الوسوم</h2>
            <!-- Page Title  -->
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="font-weight: bold;">
                            ...
                            <li class="breadcrumb-item active"><a href="#">الوسوم</a>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="d-flex align-items-center pe-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                @can('create_tag', auth()->user())
                                    <li>
                                        <a class="dropdown-item" data-mdb-toggle="modal"
                                            data-mdb-target="#create-new-tag-modal" href="#create-new-tag-modal">
