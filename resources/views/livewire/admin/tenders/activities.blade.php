<div class="container-fluid">
    <div class="p-4 mb-4">
        ...
        <div class="row mb-4" wire:ignore>
            ...
            <!-- Page Title  -->
            <h2 style="font-weight: bold;">الأنشطة</h2>
            <!-- Page Title  -->
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="font-weight: bold;">
                            ...
                            <li class="breadcrumb-item active"><a href="#">الأنشطة</a>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="d-flex align-items-center pe-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                @can('create_activity', auth()->user())
                                    <li>
                                        <a class="dropdown-item" data-mdb-toggle="modal"
                                            data-mdb-target="#create-new-activity-modal" href="#create-new-activity-modal">
            ...
            <table class="table table-bordered text-center">
                <thead>
                    <tr>
                        ...
                        @canany(['edit_activity', 'delete_activity'], auth()->user())
                            ...
                            @can('status_activity', auth()->user())
                                <td>
                                    <div class="switch">
                                        <label>
                                            نشط
                                            <input wire:click="changeStatus({{ $activity->id }})" type="checkbox"
                            ...
                            @canany(['edit_activity', 'delete_activity'], auth()->user())
                                <td>
                                    <div class="d-flex justify-content-center">
                                        @can('delete_activity', auth()->user())
                                            <a type="button" class="text-danger fa-lg me-2 ms-2"
                                                wire:click='delete({{ $activity->id }})' title="Delete">
                                                <i class="fas fa-trash-can"></i>
                                            </a>
                                        @endcan
                                        @can('edit_activity', auth()->user())
                                            <a type="button" class="text-dark fa-lg me-2 ms-2 set-button-update"
                                                data-mdb-toggle="modal" data-mdb-target="#create-new-activity-modal"
                                                href="#create-new-activity-modal" title="EditActivity"
        ...
        <div class="d-flex justify-content-between">
            ...
            <nav aria-label="...">
                <ul class="pagination pagination-circle">
                    {{ $activities->withQueryString()->onEachSide(0)->links() }}
                </ul>
            </nav>
    ...
    @canany(['edit_activity', 'create_activity'], auth()->user())
        <div class="modal top fade" id="create-new-activity-modal" tabindex="-1" data-mdb-backdrop="static"
            ...
            <div class="modal-dialog cascading-modal" style="margin-top: 4%">
                <div class="modal-content">
                    <div class="modal-c-tabs">
                        ...
                        <!-- Tabs navs -->
                        <ul class="nav md-tabs nav-tabs" id="create-new-activity" role="tablist"
                            style="background-color: #303030;">
                            <li class="nav-item" role="presentation">
                                <a data-mdb-tab-init class="nav-link active" id="create-new-activity-tab-1"
                                    href="#create-new-activity-tabs-1" role="tab"
                                    aria-controls="create-new-activity-tabs-1" aria-selected="true">
                        ...
                        <div class="tab-content" id="ex1-content">
                            ...
                            <div class="tab-pane fade show active" id="create-new-activity-tabs-1" role="tabpanel"
                                aria-labelledby="create-new-activity-tab-1">

                                <div class="modal-body">

                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <x-text-input label="اسم النشاط" name="name"
                                                model="activity"></x-text-input>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <x-select-input modelid="#create-new-activity-modal" label="الحالة"
                                                name="status" model="activity" id="add-activity-status"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn text-white blue-color create-button"
                                        wire:click='addActivity()'>حفظ</button>

                                    <button type="button" class="btn text-white blue-color update-button"
                                        wire:click='updateActivity()'>تحديث</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            Livewire.on("process-has-been-done", function() {
                ...
                $("#create-new-activity-modal").modal('hide');
                $(".create-button").show();
                $(".update-button").hide();
            });

            Livewire.on("create-new-activity-errors", function(errors) {
                $(".reset-validation").text("");
                for (let key in errors[0]) {
                    if (errors[0].hasOwnProperty(key)) {
                        $("." + key + "-create-new-activity-validation").text(errors[0][key]);
                    }
                }
            });

            Livewire.on("set-activity-status", function(data) {
                const singleSelect = document.querySelector("#add-activity-status");
