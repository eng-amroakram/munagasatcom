!(function (t) {
    ...
    function (r, e, t) {
        ...
        r.exports = function (r) {
            return (
                a(s, r) ||
                    (c && a(l, r) ? (s[r] = l[r]) : (s[r] = p("Symbol." + r))),
                s[r]
            );
        };
    },
            ...
            if (s)
                for (t in e) {
                    if (
                        ...
                        !m(c ? t : i + (u ? "." : "#") + t, r.forced) &&
                            void 0 !== n)
                    ) {
                        if (typeof o == typeof n) continue;
                        h(o, n);
                    }
                    (r.sham || (n && n.sham)) && f(o, "sham", !0),
                        d(s, t, o, r);
                }
        };
    },
    ...
    function (r, e, t) {
        ...
        (r.exports = function (r, e) {
            ...
            version: "3.6.5",
            mode: n ? "pure" : "global",
            copyright: "آ© 2020 Denis Pushkarev (zloirock.ru)",
        });
    },
    function (r, e) {
        var t = 0,
    ...
    function (r, e, t) {
                    ...
                    (t = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this;
                                Array.from(
                                    this.el.getElementsByTagName("code")
                                ).forEach(function (r) {
                                    e.data.push({
                                        lang: r.dataset.lang,
                                        name: r.dataset.name,
        ...
        Array.from(document.getElementsByTagName("mdbsnippet")).forEach(
            function (r) {
                new n(r).init();
            }
        );
        ...
        r.exports = function (r, e) {
            ...
            return (p[r] =
                ...
                !u(function () {
                    if (n && !c) return !0;
                    var r = { length: -1 };
                    n ? l(r, 1, { enumerable: !0, get: i }) : (r[1] = 1),
                        t.call(r, o, a);
                }));
        };
    },
    ...
    function (r, e, t) {
        ...
        var a = t(88);
        (e.Html5Entities = a.Html5Entities),
    ...
    function (r, e, t) {
        ...
        var o = [
            ...
            a = [
                39, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171,
                ...
                250, 251, 252, 253, 254, 255, 34, 38, 60, 62, 338, 339, 352,
                353, 376, 710, 732, 8194, 8195, 8201, 8204, 8205, 8206, 8207,
                8211, 8212, 8216, 8217, 8218, 8220, 8221, 8222, 8224, 8225,
                8240, 8249, 8250, 8364, 402, 913, 914, 915, 916, 917, 918, 919,
                920, 921, 922, 923, 924, 925, 926, 927, 928, 929, 931, 932, 933,
                934, 935, 936, 937, 945, 946, 947, 948, 949, 950, 951, 952, 953,
                954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964, 965, 966,
                967, 968, 969, 977, 978, 982, 8226, 8230, 8242, 8243, 8254,
                8260, 8472, 8465, 8476, 8482, 8501, 8592, 8593, 8594, 8595,
                8596, 8629, 8656, 8657, 8658, 8659, 8660, 8704, 8706, 8707,
                8709, 8711, 8712, 8713, 8715, 8719, 8721, 8722, 8727, 8730,
                8733, 8734, 8736, 8743, 8744, 8745, 8746, 8747, 8756, 8764,
                8773, 8776, 8800, 8801, 8804, 8805, 8834, 8835, 8836, 8838,
                8839, 8853, 8855, 8869, 8901, 8968, 8969, 8970, 8971, 9001,
                9002, 9674, 9824, 9827, 9829, 9830,
            ],
            i = {},
            c = {};
        !(function () {
            ...
            for (; t--; ) {
                ...
                u && (s = e[c] = e[c] || {}),
                    i[1]
                        ? ((n = i[1]),
                          (r[a] =
                              String.fromCharCode(c) + String.fromCharCode(n)),
                          u && (s[n] = a))
