(() => {
    var n = {
            35: () => {
                !(function () {
                    ...
                    function r(n, e) {
                        n.preventDefault();
                        var t,
                            a = n.target.checkValidity(),
                            s =
                                !e ||
                                (t = n.target).querySelector("#signonpassword")
                                    .value ===
                                    t.querySelector("#password2").value;
                        (document.getElementById(
                            "repeat-password-feedback"
                        ).style.display = s ? "none" : "block"),
                            n.target.classList.add("was-validated"),
                            a &&
                                s &&
                                (e
                                    ? (function () {
                                          ...
                                          var n = {
                                              ...
                                              repeatPassword:
                                                  i.querySelector("#password2")
                                                      .value,
                                              email: i.querySelector(
                                                  "#signonemail"
                                              ).value,
                                              newsletter:
                                                  "on" ===
                                                  i.querySelector("#newsletter")
                                                      .value,
                                          };
                                          d(i, n);
                                      })()
                                    : (function () {
                                          ...
                                          var n = {
                                              username:
                                                  l.querySelector("#username")
                                                      .value,
                                              password:
                                                  l.querySelector("#password")
                                                      .value,
                                          };
                                          d(l, n);
                                      })());
                    ...
                    function d(n, e) {
                        ...
                        t.open(
                            "POST",
                            ""
                                .concat(CONFIG.docsApiUrl, "/user/")
                                .concat(
                                    "login-form" === n.getAttribute("name")
                                        ? "login"
                                        : "register"
                                ),
                            !0
                            ...
                            (t.onreadystatechange = function () {
                                ...
                                this.status < 300
                                    ? (m(
                                      ...
                                      "register" === n.getAttribute("name") &&
                                          window.open("/newsletter", "_blank"),
                                      location.reload())
                                    : this.readyState === XMLHttpRequest.DONE &&
                                      m(n, this.response, "error");
                            }),
                    ...
                    function p() {
                        s.classList.remove("in", "show", "active"),
                            o.classList.remove("active", "show"),
                            t.classList.add("in", "show", "active"),
                            a.classList.add("active", "show");
                    }
                    document.addEventListener("dpl_loaded", function () {
                        (e = document.getElementById("navbarLogin")),
                            (t = e.querySelector("#navbarLogin-signup")),
                            (a = e.querySelector(
                                '[href="#navbarLogin-signup"]'
                            )),
                            (s = e.querySelector("#navbarLogin-login")),
                            (o = e.querySelector(
                                '[href="#navbarLogin-login"]'
                            )),
                            (l = document.querySelector("form#login")),
                            (i = document.querySelector("form#register")),
                            (c = document.querySelector(".mdb-logout-button")),
                            document
                                .querySelectorAll(
                                    ".auth-modal-toggle[data-auth-modal-tab]"
                                )
                                .forEach(function (l) {
                                    l.addEventListener("click", function (l) {
                                        var i = l.target.getAttribute(
                                            "data-auth-modal-tab"
                                        );
                                        "sign-in" === i
                                            ? (t.classList.remove(
                            ...
                            e.addEventListener("hidden.bs.modal", p),
                            n &&
                                document
                                    .querySelectorAll(".form-auth-mdb")
                                    .forEach(function (n) {
            ...
            768: () => {
                var n = "false";
                document.addEventListener("dpl_loaded", function (e) {
                    var t = document.createElement("script");
                    function a() {
                        var t;
                        (t = e.detail.isLoggedIn
                            ? e.detail.isPro && !e.detail.isProSubscription
                                ? "PRO"
                                : e.detail.isBundlePro
                                ? "BUNDLE"
                                : e.detail.userSubscriptionStatus
                            : "UNLOGGED"),
                            dataLayer.push({
                                userLicense: "".concat(t),
                                isAdBlockerOn: "".concat(n),
                            });
                    }
                    (t.src =
            ...
            217: (n, e, t) => {
                    ...
                    o = a({
                        ...
                        mounted: function () {
                            void 0 !== window.mdb &&
                                ...
                                document
                                    .querySelectorAll("[data-mdb-pill-init]")
                                    .forEach(function (n) {
                                        return mdb.Tab.getOrCreateInstance(n);
                                    }));
                        },
                    });
                function l(n, e) {
                ...
                var i = [
                    ...
                    c = a({
                        ...
                        template: function (n) {
                            ...
                            return i.includes(s.toUpperCase())
                        ...
                        template: function (n) {
                            ...
                            return n.isProSubscription
                                ...
                                : '<div class="alert alert-danger d-flex justify-content-between" role="alert" data-mdb-color="danger">\n          <p class="mb-0"><i class="fas fa-gem me-2">\n            </i>This component requires\n            <a href="'
                                      .concat(
                                          t(),
                                          '" class="text-reset"><strong>MDB Pro</strong>\n            </a> package.\n          </p>\n          <strong>\n            <a href="'
                                      )
                                      .concat(
                                          t(),
                                          '" class="text-reset d-none d-lg-block">Learn\n              more</a>\n          </strong>\n        </div>'
                                      );
                        },
                    }),
                    d = a({
                        ...
                        template: function (n) {
                            ...
                            return n.isProSubscription
                                ...
                                : '<div class="alert alert-danger d-flex justify-content-between" role="alert" data-mdb-color="danger">\n          <p class="mb-0"><i class="fas fa-gem me-2">\n            </i>This component requires\n            <a href="'
                                      .concat(
                                          t(),
                                          '" class="text-reset"><strong>MDB Pro Advanced</strong>\n            </a> package.\n          </p>\n          <strong>\n            <a href="'
                                      )
                                      .concat(
                                          t(),
                                          '" class="text-reset d-none d-lg-block">Learn\n              more</a>\n          </strong>\n        </div>'
                    ...
                    m = void 0 !== window.mdb && "undefined" != typeof mdb,
                    p = a({
                        ...
                        template: function (n) {
                            return n.isProSubscription
                                ...
                                : '\n            <div\n              class="modal fade"\n              id="modalOpenSnippetRestricted"\n              tabindex="-1"\n              aria-labelledby="exampleModalLabel"\n              aria-hidden="true"\n            >\n              <div class="modal-dialog modal-xl">\n                <div class="modal-content">\n                  <div class="modal-body">\n                    \x3c!--Section: Content--\x3e\n                    <section>\n                      <div class="text-center">\n                        <h1 class="font-weight-bold border border-primary p-5 mb-5">Access restricted</h1>\n\n                        <h5><strong>To view this snippet you must have an MDB Pro account</strong></h5>\n\n                        <p>\n                          <strong>Log in</strong> to your account or\n                          <strong>purchase an MDB Pro subscription</strong> if you are a new user\n                        </p>\n\n                        '
                                      ...
                                      .concat(
                                          m ? "text-lg-start" : "text-lg-left",
                                          ' d-lg-flex align-items-center">\n\n                          <div class="ps-lg-3">\n                            <ol class="list-unstyled">\n                              <li class="mb-2 font-weight-bold">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Latest Bootstrap 5\n                                &amp; Material Design\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Premium components\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Design blocks\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>LAB access and\n                                thousands of snippets\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>No ads in\n                                documentation\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Premium support\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Source code access\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Git repository\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Installation via NPM\n                              </li>\n                              <li class="mb-2">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Unlimited updates\n                              </li>\n                              <li class="">\n                                <i class="fas fa-check text-theme '
                                      )
                                      .concat(
                                          m ? "me-2" : "mr-2",
                                          '" style="color: #7446ac  !important;"></i>Lifetime usage\n                              </li>\n                            </ol>\n                          </div>\n                        </div>\n                      </div>\n                    </section>\n                    \x3c!--Section: Content--\x3e\n                  </div>\n                  <div class="modal-footer">\n                    <button type="button" class="btn btn-primary" '
                                      )
                                      .concat(
                                          m
                            ...
                            return n.isLoggedIn
                                ? n.isBundlePro ||
                                  (n.isProSubscription &&
                                    ...
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-bundle-sub"></div>'
                                    : n.isProSubscription &&
                                      ["SINGLE"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-single-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ESSENTIAL"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-essential-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ADVANCED"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-advanced-sub"></div>'
                                    : n.isPro
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-pro"></div>'
                                    : '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-logged"></div>'
                                : '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scroll-unlogged"></div>';
                        },
                    }),
                    u = a({
                        ...
                        template: function (n) {
                            return n.isLoggedIn
                                ? n.isProSubscription
                                    ? '<div id="gtmDC-pro-discount-sub" style="min-height:1px"></div>'
                                    : n.isPro
                                    ? '<div id="gtmDC-pro-discount-pro" style="min-height:1px"><p class="mb-1">\n            Yes, you will get a high <u>50% discount</u>. Use the following\n            coupon code on the checkout (after clicking BUY NOW) to get the\n            discount for existing customers:\n          </p>\n          <p><code class="text-uppercase h5 mb-2">zrhbksnm</code></p></div>'
                                    : '<div id="gtmDC-pro-discount-logged" style="min-height:1px"></div>'
                                : '<div id="gtmDC-pro-discount-unlogged" style="min-height:1px"></div>';
                        },
                    }),
                    h = a({
                    ...
                    G = a({
                        ...
                        template: function (n) {
                            return n.isProSubscription
                                ? n.isProSubscription &&
                                  ["SINGLE"].includes(n.userSubscriptionStatus)
                                    ? '<span>Upgrade from Single Use</span> <span class="text-theme">to Bundle</span>'
                                    : n.isBundlePro ||
                                      (n.isProSubscription &&
                                          ["ENTERPRISE"].includes(
                                              n.userSubscriptionStatus
                                    ...
                                    ? '<span>Upgrade from Essential</span> <span class="text-theme">to Bundle</span>'
                                    : n.isProSubscription &&
                                      ["ADVANCED"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<span>Upgrade from Advanced</span> <span class="text-theme">to Bundle</span>'
                                    : ""
                                : n.isPro
                                ? '<span class="text-theme">EXCLUSIVE BUNDLE</span> <span>FOR EXISTING CUSTOMERS</span>'
                                : "";
                        },
                    }),
                    W = a({
                            ...
                            return n.isLoggedIn
                                ? n.isBundlePro ||
                                  (n.isProSubscription &&
                                    ...
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-frontpage-bundle-sub"></div>'
                                    : n.isProSubscription &&
                                      ["SINGLE"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-single-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ESSENTIAL"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-essential-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ADVANCED"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-advanced-sub"></div>'
                                    : n.isPro
                                    ? '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-pro"></div>'
                                    : '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-logged"></div>'
                                : '<div style="min-height:1px;min-width:1px;" class="w-100" id="gtmDC-scrollspy-unlogged"></div>';
                        },
                    });
                function Z(n, e) {
                ...
                var K = a({
                        ...
                        template: function (n) {
                            var e = getCurrentTechnology(),
                                t = location.pathname,
                                a = 0 === t.indexOf("/newsletter"),
                                s = 0 === t.indexOf("/general"),
                                o =
                                    0 ===
                                    t.indexOf("/docs/standard/pro/enterprise/"),
                                l = 0 === t.indexOf("/docs/standard/tools/"),
                                i = "/" === t,
                                c = document.querySelector(
                                    "#dpl-navbar-v5-legacy-right-buttons"
                                ),
                                r =
                                    '<li class="nav-item me-3 me-lg-0"><a href="/cart" class="nav-link waves-effect"><i id="navbar-static-cart" alt="Cart" class="fas fa-shopping-cart"></i><span class="badge rounded-pill badge-notification bg-danger"> '.concat(
                                        n.cartContentsCount,
                                        ' </span><span class="sr-only">Cart</span></a></li>'
                                    ),
                                d = (n.notifications || [])
                                    .map(function (n) {
                                        return '<li><a gtm-id="Notifications" class="dropdown-item text-wrap" data-notification-date="'
                                            .concat(n.date, '"\n      href="')
                                            .concat(n.link, '" ')
                                            .concat(
                                                n.link.indexOf(
                                    ...
                                    .join("\n"),
                                m = n.isBundlePro
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-bundle-sub"></li>'
                                    : "ENTERPRISE" == n.userSubscriptionStatus
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-enterprise-sub"></li>'
                                    : "SINGLE" === n.userSubscriptionStatus
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-single-sub"></li>'
                                    : "ESSENTIAL" === n.userSubscriptionStatus
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-essential-sub"></li>'
                                    : "ADVANCED" === n.userSubscriptionStatus
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-advanced-sub"></li>'
                                    : n.isPro
                                    ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-pro"></li>'
                                    : '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-logged"></li>',
                                p =
                                ...
                                b =
                                    '<li class="nav-item dropdown mt-1 ms-1">\n      <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false">\n        <img src="'
                                        .concat(
                                            n.avatar,
                                            '&s=24" class="avatar avatar-24 photo rounded-circle" />\n      </a>\n      <ul class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="userDropdown" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">\n        <li>\n          <a class="dropdown-item mdb-logout-button" href="'
                                        )
                                ...
                                u =
                                    '<ul id="main-navbar" class="nav navbar-nav nav-flex-icons ml-auto ms-auto flex-row">\n      '
                                        .concat(
                                            n.cartContentsCount > 0 ? r : "",
                                            "\n      "
                                        )
                                        .concat(
                                            n.isLoggedIn
                                                ? b + "\n" + m
                                                : '<li style="min-height:1px;min-width:1px;" id="gtmDC-nav-unlogged"></li><li style="min-height:1px;min-width:1px;" id="gtmDC-login-button">\n      <a class="auth-modal-toggle btn btn-primary ripple-surface ms-2 me-1" data-auth-modal-tab="sign-in">Login</a>\n      </li>',
                                            "\n    </ul>"
                                        );
                            if (c) return u;
                            var h = "/pro/";
                                ...
                                '\n      <ul id="main-navbar" class="nav navbar-nav nav-flex-icons ml-auto ms-auto flex-row">\n        <li class="nav-item me-3 me-lg-0 d-none d-sm-inline-block dropdown">\n          <a\n            class="nav-link dropdown-toggle"\n            id="new-mdb-technologies-dropdown"\n            role="button"\n            data-mdb-toggle="dropdown"\n            aria-expanded="false"\n          >\n            Docs\n          </a>\n          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="new-mdb-technologies-dropdown">\n            <li><h5 class="dropdown-header">Bootstrap 5</h5></li>\n\n            <li>\n              <a class="dropdown-item" href="/docs/standard/"\n                ><img\n                  src="https://mdbootstrap.com/wp-content/themes/mdbootstrap4/content/en/_mdb5/_assets/img/icons/bootstrap.webp"\n                  alt=""\n                  height="15px"\n                  class="me-2"\n                />\n                <span>Standard (plain JS)'
                                    ...
                                    .concat(
                                        n.notifications
                                            ...
                                            : '<div id="navbarNotification" class="d-none"><div id="navbarNotificationCounter"></div><div id="navbarNotificationContent"></div></div>',
                                    ...
                                    .concat(
                                        n.isLoggedIn
                                            ? p + "\n" + m
                                            : '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-unlogged"></li><li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-login-button">\n      <a class="auth-modal-toggle btn btn-primary ripple-surface ms-2 me-1" data-auth-modal-tab="sign-in">Login</a>\n      </li>',
                                        "       \n\n      </ul>"
                                    )
                            );
                        },
                        mounted: function () {
                            var n = document.getElementById(
                                    "dpl-navbar-right-buttons-tmp"
                                ),
                                e = document.getElementById(
                                    "dpl-navbar-right-buttons-tmp-new"
                                );
                            n && n.remove(),
                                e && e.remove(),
                                document.addEventListener(
                                    ...
                                    function () {
                                        [].slice
                                            ...
                                            .forEach(function (n) {
                                                mdb.Dropdown.getInstance(n) ||
                                                    new mdb.Dropdown(n);
                                            });
                                        var n = document.querySelectorAll(
                                            ".dpl-docs-alert-placeholder"
                                        );
                                        n &&
                                        ...
                                        var e = (function () {
                                                function n(e) {
                                                    !(function (n, e) {
                                                        ...
                                                        (this.themeSwitcherItems =
                                                            this.element.querySelectorAll(
                                                                "[data-theme-switch-item-ref]"
                                                            )),
                                                        (this.activeTheme =
                                                            "light"),
                                                        (this.customTogglers =
                                                ...
                                                return (
                                                    ...
                                                    (t = [
                                                        ...
                                                        {
                                                            key: "setActiveThemeIcon",
                                                            value: function (
                                                                n
                                                            ) {
                                                                var e =
                                                                        this.element.querySelector(
                                                                            "[data-theme-icon=".concat(
                                                                                n,
                                                                                "]"
                                                                            )
                                                                        ).classList,
                                                                ...
                                                                this.themeSwitcherButton.innerHTML =
                                                                    '<i class="'.concat(
                                                                        t
                                                                            .toString()
                                                                            .replace(
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            value: function () {
                                                                var n =
                                                                    this.onThemeSwitcherItemClick.bind(
                                                                        this
                                                                    );
                                                                this.themeSwitcherItems.forEach(
                                                                    function (
                                                                        e
                                                                    ) {
                                                                        e.addEventListener(
                                                        ...
                                                        {
                                                            key: "initCustomTogglers",
                                                            value: function () {
                                                                var n = this;
                                                                (this.customTogglers =
                                                                    document.querySelectorAll(
                                                                        "[data-mdb-theme-toggler]"
                                                                    )),
                                                                    this.customTogglers.forEach(
                                                                        function (
                                                                            e
                                                                        ) {
                                                                            e.addEventListener(
                                                                                "change",
                                                                                function () {
                                                                                    return n.toggleDarkOrLightTheme();
                                                                                }
                                                                            );
                                                                        }
                                                                    );
                    ...
                    J = a({
                        ...
                        template: function (n) {
                            return n.isProSubscription
                                ? '<a href="/profile/my-orders/" role="button">\n    <i class="far fa-xs fa-gem ms-1 text-danger"></i>\n</a>'
                                : '<a data-mdb-ripple-init class="btn btn-danger ripple-surface" href="/docs/standard/pro" role="button">\n    MDB Pro component <i class="far fa-gem ms-1"></i>\n</a>';
                        },
                    }),
                    X = a({
                        selector: ".dpl-newmdb-pro-component-marker",
                        template: function (n) {
                            return n.isProSubscription
                                ? '<a href="/profile/my-orders/" role="button">\n    <i class="far fa-xs fa-gem ms-1 text-danger"></i>\n</a>'
                                : '<a class="btn btn-danger ripple-surface" href="/docs/standard/pro" role="button">\n    MDB Pro component <i class="far fa-gem ms-1"></i>\n</a>';
                        },
                    });
                function nn(n) {
                    var e = ["jquery", "angular", "react", "vue"].includes(
                        getCurrentTechnology()
                    );
                    if (
                        n.isProSubscription ||
                        (e && (n.isPro || n.hasAnyOrder))
                    )
                        document
                            .querySelectorAll(".mdb-pro-example")
                            .forEach(function (n) {
                                for (
                        ...
                        var t = "standard" === getCurrentTechnology(),
                            a =
                                void 0 !== window.mdb &&
                                "undefined" != typeof mdb,
                            s = a
                            ...
                            o = a ? "docs-tab-overview" : "docsTabsOverview",
                            l = a
                                ? t
                                    ? "data-mdb-modal-init"
                                    : "data-mdb-toggle"
                                : "data-toggle",
                            i = a ? "data-mdb-target" : "data-target";
                        if (
                            (document
                                .querySelectorAll(".mdb-pro-example")
                                .forEach(function (n) {
                                    document
                                        ...
                                        .forEach(function (e) {
                                            if (
                                                e.parentElement.parentElement.parentElement.parentElement.contains(
                                                    n
                                                )
                                            ) {
                                                if (
                            ...
                            document.querySelector(".mdb-docs-content-pro") &&
                                !["/docs/standard/components/modal/"].includes(
                                    window.location.pathname
                                ))
                        ) {
                            var c = document.querySelector(
                                "#docs-tab-gettingstarted"
                            );
                            if (c) {
                                if (
                                    (c.setAttribute(l, t ? "" : "modal"),
                                    c.removeAttribute("data-mdb-tab-init"),
                                    c.setAttribute(i, "#apiRestrictedModal"),
                                    c.setAttribute("type", "button"),
                                    t)
                                ) {
                                    var r = mdb.Tab.getInstance(c);
                                    r && r.dispose();
                                    var d = mdb.Modal;
                                    mdb.initMDB({ Modal: d });
                                }
                                if (
                                    ...
                                    var m = document.querySelector(o);
                                    a
                                        ? new mdb.Tab(m).show()
                                        : $(m).tab("show");
                                }
                            ...
                            var p =
                                document.querySelector("#docs-tab-examples");
                            if (p && !a) {
                                if (
                                    (p.setAttribute(l, t ? "" : "modal"),
                                    p.setAttribute(i, "#apiRestrictedModal"),
                        ...
                        h.initEvent("hide_pro_docs_init", !0, !0),
                ...
                var en = a({
                        ...
                        template: function (n) {
                            return n.isLoggedIn
                                ? n.isProSubscription
                                    ? '<div id="gtmDC-propageMDB5-sub" style="min-height:1px"></div>'
                                    : n.isPro
                                    ? '<div id="gtmDC-propageMDB5-pro" style="min-height:1px"></div>'
                                    : '<div id="gtmDC-propageMDB5-logged" style="min-height:1px"></div>'
                                : '<div id="gtmDC-propageMDB5-unlogged" style="min-height:1px"></div>';
                        },
                    }),
                    tn = a({
                            ...
                            return n.isLoggedIn
                                ? n.isBundlePro ||
                                  (n.isProSubscription &&
                                    ...
                                    ? '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-bundle-sub"></div>'
                                    : n.isProSubscription &&
                                      ["SINGLE"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-single-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ESSENTIAL"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-essential-sub"></div>'
                                    : n.isProSubscription &&
                                      ["ADVANCED"].includes(
                                          n.userSubscriptionStatus
                                      )
                                    ? '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-advanced-sub"></div>'
                                    : n.isPro
                                    ? '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-pro"></div>'
                                    : '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-logged"></div>'
                                : '<div style="height:74px;width:100%;" class="w-100" id="gtmDC-frontpage-unlogged"></div>';
                        },
                    }),
                    an = a({
                        ...
                        template: function (n) {
                            ...
                            return n.isProSubscription &&
                                ["SINGLE"].includes(n.userSubscriptionStatus)
                                ? e +
                                      '<section class="w-75 rounded-2 shadow-4 start-50 d-none d-lg-block translate-middle text-center position-absolute py-5" style="background-color: hsl(216, 55%, 85.1%); top: 68em !important">\n    <p class="h1 fw-bold">Upgrade Today <span style="color: #0e65f1">80% OFF</span> </p>\n    <p class="mt-3 fw-bold">Get access to Templates, Plugins and all technologies</p>\n    <p class="fw-bold">You get EVERYTHING there is to get from MDB with a FOREVER DISCOUNTED price ðŸ”¥</p>\n    <div>\n      <a href="https://mdbootstrap.com/upgrade/" class="btn btn-dark fw-bold my-4 shadow-6-strong">Upgrade now</a>\n    </div>\n  </section>'
                                : n.isProSubscription &&
                                  ["ESSENTIAL"].includes(
                                      n.userSubscriptionStatus
                                  )
                    ...
                    sn = a({
                        ...
                        template: function (n) {
                            return "<script>var mdbIsUserProSubscriptionGlobal = ".concat(
                                n.isProSubscription ? "true" : "false",
                                ";</script>"
                            );
                        },
                        mounted: function (n) {
                            window.mdbIsUserProSubscriptionGlobal =
                                n.isProSubscription;
                        },
                    }),
                    on = a({
                    ...
                    cn = a({
                        ...
                        template: function (n) {
                            return '<div class="modal fade" id="navbarLogin" tabindex="-1" role="dialog"> <div class="modal-dialog" role="document"> <div class="modal-content"> \n<div class="modal-body"> <ul class="nav md-pills nav-justified pills-info"> <li class="nav-item"> <a class="nav-link border-rounded" data-toggle="tab" href="#navbarLogin-login" role="tab" aria-selected="true">Login</a> </li> <li class="nav-item"> <a class="nav-link border-rounded active show" data-toggle="tab" href="#navbarLogin-signup" role="tab" aria-selected="false">Register</a> </li> </ul> \n<div class="tab-content py-0"> <div class="tab-pane fade" id="navbarLogin-login" role="tabpanel"> <form id="login" class="text-center" action="login" method="post" name="login-form"> <p class="status"></p> <div class="my-3"><style>.wp-social-login-connect-with{}.wp-social-login-provider-list{}.wp-social-login-provider-list a{}.wp-social-login-provider-list img{}.wsl_connect_with_provider{}</style><div class="wp-social-login-widget"><h5 class="wp-social-login-connect-with">Connect with:</h5><div class="wp-social-login-provider-list"><a class="mr-2" rel="nofollow" href="https://mdbootstrap.com/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Facebook&redirect_to='
                                .concat(
                                    encodeURIComponent(location.href),
                                    '" title="Connect with Facebook" class="wp-social-login-provider wp-social-login-provider-facebook" data-provider="Facebook" role="button">Facebook</a><a class="mr-2" rel="nofollow" href="https://mdbootstrap.com/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Google&redirect_to='
                                )
                                .concat(
                                    encodeURIComponent(location.href),
                                    '" title="Connect with Google" class="wp-social-login-provider wp-social-login-provider-google" data-provider="Google" role="button">Google</a><a class="mr-2" rel="nofollow" href="https://mdbootstrap.com/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Twitter&redirect_to='
                                )
                                .concat(
                                    encodeURIComponent(location.href),
                    ...
                    mn = a({
                        ...
                        template: function (n) {
                            var e,
                                ...
                                s = void 0 === a ? navigator.language : a;
                            return dn.includes(s.toUpperCase())
                                ? '<div id="mdb-gdpr-modal-cookies" name="gdpr-modal-cookies"></div>'
                                : "";
                        },
                    }),
                    pn = a({
                        ...
                        template: function (n) {
                            var e = getCurrentTechnology(),
                                ...
                                s = (n.notifications || [])
                                    .map(function (n) {
                                        return '<a gtm-id="Notifications" class="dropdown-item text-wrap" data-notification-date="'
                                            .concat(n.date, '"\n      href="')
                                            .concat(n.link, '" ')
                                            .concat(
                                                n.link.indexOf(
                                ...
                                o = n.isLoggedIn
                                    ? n.isBundlePro
                                        ...
                                        ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-enterprise-sub"></li>'
                                        : "SINGLE" === n.userSubscriptionStatus
                                        ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-sinlge-sub"></li>'
                                        : "ESSENTIAL" ===
                                          n.userSubscriptionStatus
                                        ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-essential-sub"></li>'
                                        : "ADVANCED" ===
                                        ...
                                        ? '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-pro"></li>'
                                        : '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-logged"></li>'
                                    : '<li style="margin-top:2px;min-height:1px;min-width:1px;" id="gtmDC-nav-unlogged"></li>',
                                l = t
                                    ...
                                    '<li class="nav-item dropdown">\n      <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-mdb-toggle="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">\n        <img src="'
                                        ...
                                        .concat(
                                            (n.groups || []).includes(
                                                ...
                                                ? '<a class="dropdown-item waves-effect waves-light" href="/snippets?status=4&top=all">All private snippets</a>'
                                                : "",
                                            '\n        <hr class="m-0">\n        <a class="dropdown-item mdb-logout-button" href="'
                                        )
                                        .concat(
                            ...
                            n && n.remove(),
                                ...
                                jQuery(document).ready(function (n) {
                                    var e,
                                        ...
                                        a,
                                        s,
                                        o = getCurrentTechnology(),
                                        l = "mdb_".concat(
                                            o,
                                            "_last_seen_notification="
                                        );
                                    document
                                        .getElementById("navbarNotification")
                                        .addEventListener(
                                            "show.bs.dropdown",
                                            function () {
                                                var e = n(
                    ...
                    bn = a({
                        ...
                        template: function (n) {
                            ...
                            return e === t
                                ? ""
                                : "standard" === t
                                ? '<div class="alert fade mt-3 text-black"\n        id="technology-change"\n        data-mdb-position="top-right"\n        data-mdb-hidden="true"\n        data-mdb-autohide="true"\n        data-mdb-width="25%"\n        data-mdb-delay="2000"\n        role="alert"\n        data-mdb-color="primary">\n        You have switched to MDB '.concat(
                                      t,
                                ...
                                : '<script>toastr["info"]("You have switched to MDB '.concat(
                                      t,
                                      ' version." );</script>'
                                  );
                        },
                ...
                function un(n) {
                    return (
                        (function (n) {
                            if (Array.isArray(n)) return hn(n);
                        })(n) ||
                        (function (n) {
                            if (
                ...
                function gn(n) {
                    for (var e = 1; e < arguments.length; e++) {
                        ...
                        e % 2
                            ? fn(Object(t), !0).forEach(function (e) {
                                  vn(n, e, t[e]);
                              })
                            ...
                            : fn(Object(t)).forEach(function (e) {
                ...
                window.addEventListener("DOMContentLoaded", function () {
                    var n,
                        e = void 0 !== window.mdb && "undefined" != typeof mdb;
                    e && (n = new ln.p());
                    var t = new XMLHttpRequest();
                    t.open("GET", "".concat(CONFIG.docsApiUrl, "/user"), !0),
                        ...
                        (t.onreadystatechange = function () {
                            ...
                            if (
                                ...
                                var Z = JSON.parse(t.response).notifications;
                                nn({ isLoggedIn: !1 }),
                                    s({
                                        userData: {
                                            notifications: Z,
                        ...
                        (function () {
                            ...
                            if (
                                ...
                                var e = new XMLHttpRequest();
                                e.open("GET", "/".concat(location.search), !0),
                                    e.send(n);
                            }
                        })();
                });
            ...
            610: () => {
                ...
                document.addEventListener("dpl_loaded", function () {
                    var n,
                        ...
                        t,
                        a,
                        s = window.location.href.match(
                            /(standard|jquery|angular|react|vue)/
                        ),
                        o = s ? s[0] : "standard",
                        l = document.getElementById("navbarNotification");
                    l &&
                        (l.addEventListener("click", function () {
                            ...
                            t.setTime(t.getTime() + 15552e6),
                                (document.cookie = "mdb_"
                                    .concat(o, "_last_seen_notification=")
                                    .concat(Date.now(), "; expires=")
                        ...
                        (n = 0),
                        (e = document
                            .getElementById("navbarNotificationContent")
                            .querySelectorAll(".dropdown-item")),
                        (t = document.getElementById(
                            "navbarNotificationCounter"
                        )),
                        (a = getCookie(
                            "mdb_".concat(o, "_last_seen_notification")
                        )),
                        e.forEach(function (e) {
                            var t = new Date(
                                e.getAttribute("data-notification-date")
                            ).getTime();
                            (!a || t > a) && n++;
                        }),
                        n > 0 &&
                            ((t.innerText = "" + n), (t.style.display = "")));
                });
            },
            923: (n, e, t) => {
                "use strict";
                ...
                var c = (function () {
                    function n() {
                        !(function (n, e) {
                            ...
                            (this.form = document.querySelector("#new_rating")),
                            (this.formLoader = document.querySelector(
                                "#reviews-form-loader"
                            )),
                            (this.reviewsList =
                                document.querySelector("#reviews-list")),
                            (this.alertInstance = mdb.Alert.getInstance(
                                document.getElementById("review-alert-danger")
                            )),
                            (this.userData = null),
                            (this.reviews = null),
                            (this.reviewsOnPage = 10),
                            (this.productId = null);
                    }
                    var e, t;
                    return (
                        ...
                        (t = [
                                ...
                                value: function (n) {
                                    if (this.form) {
                                        if (
                                            ((this.userData = n),
                                            (this.productId =
                                                this.form.dataset.product ||
                                                this.reviewsList.dataset
                                                    .product),
                                            !n.isLoggedIn)
                                        ) {
                                            var e = s(
                                                document.querySelectorAll(
                                                    ".reviews-not-loggedin"
                                                )
                                            );
                                            for (var t in e)
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    for (var t in ((e.value = 5), this.stars))
                                        this.stars[t].addEventListener(
                                            "mouseover",
                                            function (t) {
                                                var a = parseInt(
                                                    t.target.dataset.index
                                                );
                                                n.markStarsAsActive(a - 1),
                                                    (e.value = a);
                                            }
                                        );
                                },
                            ...
                            },
                            {
                                ...
                                value: function (n) {
                                    this.unmarkActive();
                                    for (var e = 0; e <= n; e++)
                                        this.stars[e].classList.remove("far"),
                                            this.stars[e].classList.add("fas");
                                },
                            },
                            {
                                key: "unmarkActive",
                                value: function () {
                                    for (var n in this.stars)
                                        this.stars[n].classList.remove("fas"),
                                            this.stars[n].classList.add("far");
                                },
                            },
                            {
                                key: "renderReviews",
                                ...
                                value: function () {
                                    ...
                                    e.open(
                                        ...
                                        (e.onreadystatechange = function () {
                                            ...
                                            this.status >= 200 &&
                                            this.status < 300
                                                ? ((n.reviews = JSON.parse(
                                                      e.response
                                                  )),
                                                  n.generateLatestReviews(),
                                                  n.generateTopReviews(),
                                                  n.loadRatingData())
                                                : this.readyState ===
                                                      XMLHttpRequest.DONE &&
                                                  this.status,
                                ...
                                value: function () {
                                            ...
                                            '\n            <nav class="my-4" aria-label="...">\n                <ul class="pagination pagination-circle justify-content-center">\n                    <li class="page-item '
                                                .concat(
                                                    n - 1 <= 0
                                                        ? "disabled"
                                                        : "",
                                                    '">\n                        <a class="page-link reviews-paginate" data-page="'
                                                )
                                                .concat(
                                                    n - 1,
                                    ...
                                    for (
                                        ...
                                        a += '<li class="page-item '
                                            .concat(
                                                l === n ? "active" : "",
                                                '">\n                                    <a href="#" class="page-link reviews-paginate" data-page="'
                                            )
                                            .concat(l, '" href="">')
                                            .concat(l)
                                            .concat(
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var n,
                                        e = "",
                                        t = a(
                                            this.reviews.filter(function (n) {
                                                return 1 === n.featured;
                                            })
                                        );
                                    try {
                                        for (t.s(); !(n = t.n()).done; ) {
                                            var s = n.value;
                                            e +=
                                                '\n            \x3c!-- Review --\x3e\n            <div class="shadow-4 p-4 rounded-lg mb-4">\n                <img class="shadow-1-strong rounded-circle" style="width: 100px;" src="'
                                                    .concat(
                                                        s.avatar,
                                                        '" alt="Avatar"/>\n                <div class="pt-3">\n                    <h5 class="">'
                                                    )
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var n = (
                                        this.reviews.reduce(function (n, e) {
                                            return n + +e.rating;
                                        }, 0) / this.reviews.length
                                    ).toFixed(1);
                                    (document.querySelector(
                                        "#reviews-product-stars"
                                    ).innerHTML = this._getStarsTemplate(n)),
                                        (document.querySelector(
                                            "#reviews-average-rating"
                                        ).innerText = n),
                                        (document.querySelector(
                                            "#reviews-product-count"
                                        ).innerText = this.reviews.length);
                                },
                            },
                            {
                                ...
                                value: function (n) {
                                    ...
                                    try {
                                        for (o.s(); !(e = o.n()).done; ) {
                                            var l = e.value;
                                            t +=
                                                '\n            \x3c!-- Review --\x3e\n            <div class="shadow-4 p-4 rounded-lg mb-4">\n                <img class="shadow-1-strong rounded-circle" style="width: 40px;" src="'
                                                    .concat(
                                                        l.avatar,
                                                        '" alt="Avatar"/>\n                <div class="pt-3">\n                    <h5 class="">'
                                                    )
                            ...
                            },
                            {
                                ...
                                value: function (n) {
                                    var e = Math.floor(+n),
                                        ...
                                        a = 5 - (e + (t ? 1 : 0));
                                    return (
                                        '<li><i class="fas fa-star fa-sm text-primary text-theme me-1"></i></li>'.repeat(
                                            e
                                        ) +
                                        '<li><i class="fas fa-star-half-alt fa-sm text-primary text-theme me-1"></i></li>'.repeat(
                                            t ? 1 : 0
                                        ) +
                                        '<li><i class="far fa-star fa-sm text-primary text-theme me-1"></i></li>'.repeat(
                                            a
                                        )
                                    );
                                },
            ...
            434: () => {
                ...
                function s(n) {
                    ...
                    return new Promise(function (n, s) {
                        ...
                        l.open(t, e, !0),
                            l.setRequestHeader("Content-Type", o),
                            (l.onreadystatechange = function () {
                                this.readyState === XMLHttpRequest.DONE &&
                                this.status >= 200 &&
                                this.status < 300
                ...
                document.addEventListener("dpl_loaded", function () {
                    var n,
                        e = "standard" === getCurrentTechnology(),
                        t = void 0 !== window.mdb && "undefined" != typeof mdb,
                        o = t
                            ? e
                                ? "a[data-mdb-modal-init]"
                        ...
                        i = {},
                        c =
                            document.getElementById("modalOpenSnippet") ||
                            document.getElementById(
                                "modalOpenSnippetRestricted"
                            );
                    t && (n = new mdb.Modal(c)),
                        b() ||
                            -1 ===
                        ...
                        document
                            ...
                            .addEventListener("click", function (e) {
                                if (
                                    Array.from(e.target.children).some(
                                        function (n) {
                                    ...
                                    var r = e.target,
                                        d =
                                            r.closest("div").querySelector(l) ||
                                            r.closest("div").querySelector(o),
                                        h = (function (n) {
                                            var e,
                                                t = a(),
                                                s = {
                                            ...
                                            document
                                                ...
                                                .querySelector(".docs-pills ul")
                                        );
                                    "modalOpenSnippet" === c.id &&
                                        (document
                                            .querySelector(
                                                ".mdb-snippets-prepare-text"
                                            )
                                            .classList.remove("d-none"),
                                        document
                                            .querySelector(
                                                ".mdb-snippets-ready-text"
                                            )
                                            .classList.add("d-none"),
                                        document
                                            .querySelector(".open-snippet")
                                            .classList.add("disabled"),
                                        document
                                            .querySelector(".open-snippet")
                                            .querySelector(".spinner-border")
                                            .classList.remove("d-none")),
                                        t ? n.show() : $(c).modal("show"),
                                        s({
                                                    ...
                                                    (e = function (e) {
                                                        ...
                                                        var t = (function (n) {
                                                            return {
                                                                ...
                                                                js: n.javascript,
                                                                status: 3,
                                                                docs: window.location.href.split(
                                                                    "?"
                                                                )[0],
                                                            };
                                                        })(h);
                                                            ...
                                                            : (function (n, e) {
                                                                  ...
                                                                  (t = e),
                                                                      ...
                                                                      s({
                                                                          url:
                                                                              "/api/snippets/" +
                                                                              i.technology.toLowerCase() +
                                                                              "/temp/snippets/temp/create",
                                                                          method: "POST",
                                                                          contentType:
                                                                              "application/json",
                                                                          data: t,
                    ...
                    var r = c.querySelector("a.open-snippet");
                    r &&
                        r.addEventListener("click", function () {
                            return n.hide();
                        });
                    var d = c.querySelector(".auth-modal-toggle");
                    function m(n, e) {
                        var t = encodeURIComponent(i.technology).toLowerCase(),
                        ...
                        !(function (n, e, t) {
                            ...
                            s
                                ? ((s =
                                      "string" == typeof s ? JSON.parse(s) : s),
                                  c
                                      .querySelector("a.open-snippet")
                                      .setAttribute(
                                          "href",
                                          "/snippets/" +
                                              t +
                    ...
                    function b() {
                        return (
                            -1 !== document.cookie.indexOf("mdb_snippets_auth")
                        );
                    }
                    function u() {
                        "modalOpenSnippet" === c.id &&
                            (document
                                .querySelector(".mdb-snippets-prepare-text")
                                .classList.add("d-none"),
                            document
                                .querySelector(".mdb-snippets-ready-text")
                                .classList.remove("d-none"),
                            document
                                .querySelector(".open-snippet")
                    ...
                    (("eCommerce" !== (t = a()) &&
                        ...
                        document.addEventListener(
                            ...
                            function (n) {
                                n.target.classList &&
                                    n.target.classList.contains("toolbar") &&
                                    n.target.previousElementSibling.dataset
                                        .editor;
                            }
                        );
            },
