...
class Cities extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.tenders.cities', [
            'cities' => $cities
        ]);
    }
    ...
    public function changeStatus($id)
    {
        ...
        if ($result) {
            $this->alertMessage("تم تعديل حالة المدينة بنجاح", 'success');
            return true;
        }
    ...
    public function delete($id)
    {
        ...
        if ($result) {
            $this->alertMessage("تم حذف المدينة بنجاح", 'success');
            return true;
        }
        $this->alertMessage("حدث خطأ يرجى المحاولة مرة اخرى", 'error');
        return false;
    ...
    public function addCity()
    {
        ...
        if (count($errors)) {
            $this->dispatch('create-new-city-errors', $errors);
    ...
    public function updateCity()
    {
        ...
        $rules = $service->rules($this->city_id);
        $messages = $service->messages();
        $validator = Validator::make($data, $rules, $messages);
        $errors = array_map(fn ($value) => $value[0], $validator->errors()->toArray());
        ...
        $result = $service->update($data, $this->city_id);
